...
6. [Периодическй запуск lua скриптов](lua_rus.md#периодический-запуск-скриптов)
7. [Скрипт инициализвции](lua_rus.md#скрипт-инициализации)
...
:warning: **Внимание, данный функционал начинает действовать после перезагрузки шлюза!!!**
